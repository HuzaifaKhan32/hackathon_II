          ...
          <div className="hidden lg:flex lg:w-1/2 h-full relative flex-col justify-center items-center p-12 overflow-hidden bg-[#0d0915]">
            ...
            <div className="relative z-10 w-full max-w-lg">
              ...
              <div className="relative h-[500px] w-full">
                ...
                <div className="absolute top-32 right-0 w-72 p-6 rounded-2xl bg-gradient-to-br from-[#362e4a] to-[#1e182d] border border-primary/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-float-delayed z-20" style={{ animationDelay: '1s' }}>
                  ...
                  <div className="bg-black/20 rounded-xl p-3 mb-3 border border-white/5">
                    <p className="text-sm text-slate-300 leading-relaxed">&quot;Based on your email, I&apos;ve scheduled the meeting for 2 PM and prepared the agenda.&quot;</p>
                  </div>
                  <div className="flex gap-2">
                    <button className="flex-1 py-2 rounded-lg bg-primary text-white text-xs font-bold hover:bg-primary/90 transition-colors">Approve</button>
                    <button className="flex-1 py-2 rounded-lg bg-white/5 text-slate-300 text-xs font-bold hover:bg-white/10 transition-colors">Edit</button>
                  </div>
                </div>
                ...
                <div className="absolute bottom-20 left-10 w-56 p-4 rounded-2xl bg-gradient-to-tr from-[#2a2438] to-[#151022] border border-white/5 shadow-xl animate-float" style={{ animationDelay: '2s' }}>
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center">
                      <span className="material-symbols-outlined text-blue-400 text-xs">calendar_today</span>
                    </div>
              ...
              <div className="mt-8">
                ...
                <p className="text-slate-400 text-lg max-w-md">Experience the future of productivity. Let our AI handle the noise while you focus on what matters.</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 h-full overflow-y-auto flex items-center justify-center p-6 sm:p-12 relative z-20">
            <div className="w-full max-w-[480px] flex flex-col">
              ...
              <div className="mb-8 text-center sm:text-left">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-base">Enter your details to access your workspace.</p>
              </div>

              {/* Glass Card Form - USING EXACT CLASS FROM DESIGN */}
              <div className="glass-panel p-8 rounded-[2rem] w-full">
                ...
                <div className="mt-8 text-center">
                  <p className="text-slate-400 text-sm">
                    ...
                    <Link href="/sign-up" className="text-primary font-semibold hover:text-white transition-colors">
                      Sign up now
                    </Link>
                  </p>
                </div>
