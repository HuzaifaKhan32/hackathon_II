...
const Footer = () => {
    return (
        <footer className="bg-main-bg-dark border-t border-white/5">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 lg:px-8">
                <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                    ...
                    <nav aria-label="Footer" className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12">
                        <div className="pb-6">
                            <Link className="text-sm leading-6 text-gray-400 hover:text-white transition-colors" href="#">Privacy Policy</Link>
                        </div>
                        <div className="pb-6">
                            <Link className="text-sm leading-6 text-gray-400 hover:text-white transition-colors" href="#">Terms of Service</Link>
                        </div>
                        <div className="pb-6">
                            <Link className="text-sm leading-6 text-gray-400 hover:text-white transition-colors" href="#">Contact Support</Link>
                        </div>
                    </nav>
                ...
                <div className="mt-8 border-t border-white/5 pt-8 md:flex md:items-center md:justify-center">
                    <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">© 2023 TodoAI. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
